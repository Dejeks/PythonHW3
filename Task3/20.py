...
rus_values = {'А': 1, 'Б': 3, 'В': 1, 'Г': 3, 'Д': 2, 'Е': 1, 'Ё': 3, 'Ж': 5, 'З': 5, 'И': 1,
...
if all(c.isalpha() and c in eng_values for c in word):
    values = eng_values
elif all(c.isalpha() and c in rus_values for c in word):
    values = rus_values
else:
    print('Допустимы только слова, состоящие из букв одного алфавита')
    exit()
